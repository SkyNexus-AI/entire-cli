...
- `entire/`: Main CLI entry point. Also home to kubectl-style plugin dispatch (`entire <name>` → `entire-<name>` on PATH) — see [Plugin Dispatch](docs/architecture/plugin-dispatch.md).
